...
function apple(x){
    // take in the integer 
    //square the integer by itself and if the result is more than 1000 return 'It\'s hotter than the sun!!'
    // if not return 'Help yourself to a honeycomb Yorkie for the glovebox.'
